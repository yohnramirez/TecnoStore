<?php
    ...
    $query = "SELECT * FROM producto WHERE categoria = 'Headphone'";
...
<body>
    ...
    <nav class="nav nav-pills flex-column flex-sm-row">
        ...
        <a class="flex-sm-fill text-sm-center nav-link active" href="headphone.php">Headphones</a>
        <a class="flex-sm-fill text-sm-center nav-link" href="mouse.php">Mice</a>
    ...
    <?php if(empty($resultado)){?>
        ...
        <strong>Sorry!</strong> This product will come soon.
