<?php
    ...
    $query = "SELECT * FROM producto WHERE categoria = 'Keyboard'";
...
<body>
    ...
    <hr>
    <div class="container">
        <h1 class="text-center">Keyboards</h1>
    </div>
    <hr>

    <nav class="nav nav-pills flex-column flex-sm-row">
        <a class="flex-sm-fill text-sm-center nav-link" href="product.php">All</a>
        <a class="flex-sm-fill text-sm-center nav-link active" href="keyboard.php">Keyboards</a>
