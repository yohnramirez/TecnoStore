...
<body>
    ...
    <nav class="nav nav-pills flex-column flex-sm-row">
        <a class="flex-sm-fill text-sm-center nav-link active" href="product.php">All</a>
    ...
    <div class="card_ind card-column-4" style="max-width:100%;">
        ...
        <div class="card" style="width: 17rem; margin: 10px; text-align:center; background:#EFEAF5;">
            <img style="width: 16.9rem; height: 10rem;" src="images/<?php echo $row['imagen'] ?>" class="card-img-top">
            <div class="card-body">
